<template>
  <div class="app-container">
    ...
    <el-table border v-loading="loading" :data="memberList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="OPENID" align="left" prop="openid" />
...
<script>
import { listMember, getMember, delMember, addMember, updateMember, exportMember } from "@/api/tax/member";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除会员信息编号为"' + memberIds + '"的数据项?', "警告", {
